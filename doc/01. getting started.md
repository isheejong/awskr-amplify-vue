...
2. 설치된 vue 명령어를 이용하여, 프로젝트를 생성합니다. 설치 옵션으로 Vuex 와 Router 를 선택합니다.
    ...
    > Cloud9 환경에서 webpack 으로 애플리케이션을 빌드하고 페이지에 접근 하는 경우,  Invalid Header 오류가 합니다. 해당 문제를 해결하기 위해서 package.json 디렉토리와 동일 한 위치에 vue.config.js 파일을 생성하고 disableHostCheck 를 false 로 변경하면, 문제를 해결 할 수 있습니다.

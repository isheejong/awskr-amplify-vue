...
Amplify 기반의 애플리케이션을 개발하기 위해 클라우드 사용자 계정이 소유해야 하는 Role 에 대한 Policy 입니다. Json 파일로 작성된 파일을 다운로드 받으려면 <a href="../etc/amplifyUserPolicy" target="_blank">여기</a> 를 클릭하세요.
